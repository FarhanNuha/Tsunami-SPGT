...
Q_CONSTINIT static const qt_meta_stringdata_MenuBar_t qt_meta_stringdata_MenuBar = {
    {
        ...
        QT_MOC_LITERAL(8, 12),  // "themeChanged"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 9),  // "themeName"
        QT_MOC_LITERAL(32, 15),  // "onThemeSelected"
        QT_MOC_LITERAL(48, 8),  // "QAction*"
        QT_MOC_LITERAL(57, 6)   // "action"
    },
    "MenuBar",
    "themeChanged",
    "",
...
void MenuBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onThemeSelected((*reinterpret_cast< std::add_pointer_t<QAction*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MenuBar::themeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MenuBar::themeChanged(const QString & _t1)
{
